...
import { Check, Download, ExternalLink, Info, ShieldCheck } from 'lucide-react';
  ...
  return (
    <>
      <div className={`w-full backdrop-blur-lg rounded-2xl p-4 sm:p-5 border transition-all duration-300 ${t.card}`} id="download-apps-section">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 w-full lg:w-auto">
            ...
            <button
              ...
              className={`flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl border text-xs font-medium transition-all group cursor-pointer ${t.isDark
            ...
            <button
              disabled
              className={`flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl border text-xs font-medium cursor-not-allowed opacity-70 ${t.isDark
        ...
        {downloadMsg && (
          <div className={`mt-3 p-2.5 border rounded-xl flex items-center gap-2 text-xs transition-all ${t.isDark
      ...
      >
        <div className={`space-y-4 py-1 ${t.isDark ? 'text-gray-200' : 'text-slate-800'}`}>
          <div className={`p-3 border rounded-xl flex items-start gap-3 ${t.isDark ? 'bg-blue-950/40 border-blue-800/40 text-blue-200' : 'bg-blue-50 border-blue-200 text-blue-900'
            }`}>
